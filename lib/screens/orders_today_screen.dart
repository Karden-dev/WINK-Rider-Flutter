                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      onSelected: (String result) {
                         // TODO: Implémenter actions (Statuer, Retour, etc.)
                         debugPrint("Action sélectionnée: $result pour Cde ${order.id}"); // Correction: print -> debugPrint
                         // Ex: if (result == 'status') { _openStatusModal(context, order); }
                      },
                      itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                        // --- AJOUTER LES ACTIONS POSSIBLES ICI ---
                        // Exemple basé sur rider-common.js
                        ...
                        // Toujours ajouter un séparateur si des actions sont présentes
                        ...
                        const PopupMenuItem<String>(value: 'call_client', child: ListTile(leading: Icon(Icons.call), title: Text('Appeler Client'))),
                         // Ajoutez d'autres actions (SMS, WhatsApp) si nécessaire
                      ],
                    ),
                  ],
                ),
