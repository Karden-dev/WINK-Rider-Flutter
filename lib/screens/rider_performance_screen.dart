...
import 'package:confetti/confetti.dart'; // CORRECTION: Import du bon package
...
class _RiderPerformanceScreenState extends State<RiderPerformanceScreen> {
  ...
  Widget _buildPeriodSelector() {
   ...
   Widget _buildEncouragementCard(PerformanceStats stats) {
    ...
    // CORRECTION: Ajout des accolades pour le linting
             ...
             Row(
                ...
                children: [
                  const Text('Prime de performance estimée:', style: TextStyle(fontWeight: FontWeight.bold)),
                   Text(
                      formatAmount(remuneration.performanceBonus), // Utilise la rémunération déjà calculée
                ...
                BarChartData(
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchTooltipData: BarTouchTooltipData(
                      // Le linter (Diagnostic 6) suggère 'const' pour BarTooltipItem, 
                      // mais c'est incorrect car le premier argument est dynamique.
