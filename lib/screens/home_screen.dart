...
// --- NOUVEAUX IMPORTS DES ÉCRANS MIGRÉS ---
import 'orders_today_screen.dart';      // Courses du Jour
import 'orders_history_screen.dart';     // Mes courses
import 'orders_relaunch_screen.dart';    // À relancer
import 'riders_returns_screen.dart';     // Retours
import 'rider_cash_screen.dart';         // Ma Caisse
import 'rider_performance_screen.dart';  // Mes Performances
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              currentAccountPicture: const CircleAvatar( // 'const' retiré de CircleAvatar pour être sûr
                backgroundColor: Colors.white,
                // Utiliser une icône appropriée de Material Icons
                // CORRECTION: 'const' retiré de Icon pour résoudre 'const_with_non_const'
            ...
            // --- ÉLÉMENTS DE MENU AVEC COMPTEURS ET NAVIGATION IMPLÉMENTÉE ---
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran des courses du jour
                Navigator.of(context).pop(); // Ferme le drawer
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const OrdersTodayScreen()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran de l'historique des courses
                Navigator.of(context).pop();
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const OrdersHistoryScreen()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran de relance
                Navigator.of(context).pop();
            ...
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran des retours
                Navigator.of(context).pop();
            ...
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran de caisse
                Navigator.of(context).pop();
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const RiderCashScreen()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                // Naviguer vers l'écran de performance
                Navigator.of(context).pop();
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const RiderPerformanceScreen()));
              },
            ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () {
                  // Correction : Assurez-vous d'utiliser un Builder ou le context correct pour Scaffold.of
